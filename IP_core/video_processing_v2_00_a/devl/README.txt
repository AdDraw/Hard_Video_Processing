...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\Designs\Inzynierka_Adam_HEHE\Inzynierka_Adam.3
  logical library name                       : video_processing_v2_00_a
  top name                                   : video_processing
  version                                    : 2.00.a
  type                                       : PLB (v4.6) slave
...
- XPS interface file(s)
  ...
  data/video_processing_v2_1_0.mpd
  ...
  data/video_processing_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/video_processing.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/video_processing_xst.prj
...
- BFM simulation IP testbench file(s)
  ...
  devl/bfmsim/pcores/video_processing_tb_2_00_a/hdl/vhdl/video_processing_tb.vhd

    This is the peripheral IP testbench to be used in BFM or hardware simualtion.

  devl/bfmsim/pcores/video_processing_tb_2_00_a/data/video_processing_tb_v2_1_0.mpd

    This is Microprocessor Peripheral Description file for the peripheral IP testbench.

  devl/bfmsim/pcores/video_processing_tb_2_00_a/data/video_processing_tb_v2_1_0.pao
...
- Driver source file(s)
  ...
  src/video_processing_selftest.c
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/video_processing_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/video_processing_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	C:\Designs\Inzynierka_Adam_HEHE\Inzynierka_Adam.3\C:\Xilinx\14.7\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\plbv46_slave_single_v1_01_a\doc\plbv46_slave_single.pdf
